...
class AutomationWorker {
  ...
  async start() {
    ...
    const env = {
      ...
      FILTER_REWARD_MODE: String(this.settings.filterRewardMode || "all"),
      ...
      FILTER_NOTE_CONTAINS: String(this.settings.filterNoteContains || ""),
      OPEN_TAP_REQUEST_LEAD_MS: String(this.settings.openTapRequestLeadMs ?? 2500),
      OPEN_TAP_TRANSPORT_COMPENSATION_MS: String(this.settings.openTapTransportCompensationMs ?? 0),
